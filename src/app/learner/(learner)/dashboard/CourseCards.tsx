          ...
          <div key={course.id} className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-all">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">#{course.enrollmentNumber}</p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>{course.facultyName} - {course.designation}</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                <MapPin className="w-4 h-4" />
                <span>{course.hospitalName}, {course.location}</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <p className="text-sm text-gray-600">
                <span className="font-medium">Program:</span> {course.contactProgram}
              </p>
            </div>
          </div>
        ))}
